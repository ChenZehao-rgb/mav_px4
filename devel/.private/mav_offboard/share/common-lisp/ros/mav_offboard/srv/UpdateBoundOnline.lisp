...
(cl:defmethod cl:initialize-instance :after ((m <UpdateBoundOnline-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateBoundOnline-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_offboard-srv:<UpdateBoundOnline-request> is deprecated: use mav_offboard-srv:UpdateBoundOnline-request instead.")))

(cl:ensure-generic-function 'velBound-val :lambda-list '(m))
(cl:defmethod velBound-val ((m <UpdateBoundOnline-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:velBound-val is deprecated.  Use mav_offboard-srv:velBound instead.")
  (velBound m))

(cl:ensure-generic-function 'accBound-val :lambda-list '(m))
(cl:defmethod accBound-val ((m <UpdateBoundOnline-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:accBound-val is deprecated.  Use mav_offboard-srv:accBound instead.")
  (accBound m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateBoundOnline-request>)))
  ...
  "mav_offboard/UpdateBoundOnlineRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateBoundOnline-request)))
  "Returns string type for a service object of type 'UpdateBoundOnline-request"
  "mav_offboard/UpdateBoundOnlineRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <UpdateBoundOnline-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateBoundOnline-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_offboard-srv:<UpdateBoundOnline-response> is deprecated: use mav_offboard-srv:UpdateBoundOnline-response instead.")))
...
(cl:defmethod isBoundUpdate-val ((m <UpdateBoundOnline-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:isBoundUpdate-val is deprecated.  Use mav_offboard-srv:isBoundUpdate instead.")
  (isBoundUpdate m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateBoundOnline-response>)))
  ...
  "mav_offboard/UpdateBoundOnlineResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateBoundOnline-response)))
  "Returns string type for a service object of type 'UpdateBoundOnline-response"
  "mav_offboard/UpdateBoundOnlineResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateBoundOnline)))
  ...
  "mav_offboard/UpdateBoundOnline")