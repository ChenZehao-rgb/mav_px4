...
(cl:defmethod cl:initialize-instance :after ((m <GenTrajOnline-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenTrajOnline-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_offboard-srv:<GenTrajOnline-request> is deprecated: use mav_offboard-srv:GenTrajOnline-request instead.")))
...
(cl:defmethod pose-val ((m <GenTrajOnline-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:pose-val is deprecated.  Use mav_offboard-srv:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <GenTrajOnline-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:twist-val is deprecated.  Use mav_offboard-srv:twist instead.")
  (twist m))

(cl:ensure-generic-function 'isUpdateState-val :lambda-list '(m))
(cl:defmethod isUpdateState-val ((m <GenTrajOnline-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:isUpdateState-val is deprecated.  Use mav_offboard-srv:isUpdateState instead.")
  (isUpdateState m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GenTrajOnline-request>)))
  ...
  "mav_offboard/GenTrajOnlineRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenTrajOnline-request)))
  "Returns string type for a service object of type 'GenTrajOnline-request"
  "mav_offboard/GenTrajOnlineRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GenTrajOnline-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenTrajOnline-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_offboard-srv:<GenTrajOnline-response> is deprecated: use mav_offboard-srv:GenTrajOnline-response instead.")))

(cl:ensure-generic-function 'setPointRaw-val :lambda-list '(m))
(cl:defmethod setPointRaw-val ((m <GenTrajOnline-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_offboard-srv:setPointRaw-val is deprecated.  Use mav_offboard-srv:setPointRaw instead.")
  (setPointRaw m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GenTrajOnline-response>)))
  ...
  "mav_offboard/GenTrajOnlineResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenTrajOnline-response)))
  "Returns string type for a service object of type 'GenTrajOnline-response"
  "mav_offboard/GenTrajOnlineResponse")
